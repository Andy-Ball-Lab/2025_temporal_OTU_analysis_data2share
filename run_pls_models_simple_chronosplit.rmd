...
# R2 1:1
# Fit the regression model of truth vs predictions
lm_fit <- lm(truth ~ .pred, data = test_preds)
# Residual sum of squares from regression model
SSE_reg <- sum(resid(lm_fit)^2)
# Residual sum of squares from 1:1 (slope = 1, intercept = 0)
SSE_11 <- sum((test_preds$truth - test_preds$.pred)^2)
# Compute R²₁:₁ as defined
r2_11 <- 1 - SSE_reg / SSE_11
